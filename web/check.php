...
check(is_writable(__DIR__.'/../app_public/cache'), sprintf('Checking that app_public/cache/ directory is writable'), 'Change the permissions of the app/cache/ directory so that the web server can write in it', true);
check(is_writable(__DIR__.'/../app_public/logs'), sprintf('Checking that the app_public/logs/ directory is writable'), 'Change the permissions of the app/logs/ directory so that the web server can write in it', true);
